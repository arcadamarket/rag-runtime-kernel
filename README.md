...
| **Determinism** | As reliable as the model following instructions. | Deterministic state machine — formally verified (TLA+) and covered by 1,469 passing tests. |
...
| **Version** | Specification **v3.2.5** | Runtime kernel **v0.4.18** |
