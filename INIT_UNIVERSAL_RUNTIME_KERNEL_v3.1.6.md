# INIT_UNIVERSAL_RUNTIME_KERNEL_v3.1.6
...
> Derived from v3.1.5 + v3.1.6 patches (pre-flight gate enforcement, WSL-exec tool hierarchy, stop-and-diagnose protocol, known-issues registry).
> Supersedes: all prior versions through v3.1.5.
...
| init_prompt | INIT_UNIVERSAL_RUNTIME_KERNEL_v3.1.5.md | This specification |
