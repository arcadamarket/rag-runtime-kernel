...
| **External dependencies** | Tier 1: zero — single markdown file. Tier 2: Python 3.10+ only | Node.js + Claude Code CLI | Rust binary. Single install, zero runtime deps | Varies by implementation. Core pattern = none |
